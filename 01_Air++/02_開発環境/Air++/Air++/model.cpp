...
// 静的メンバ変数宣言
//=============================================================================
CModel::Model CModel::m_aGeneralModel[CModel::GENERAL_MODEL_MAX] = {};
...
//モデルクラスのクリエイト処理
//=============================================================================
CModel * CModel::Create(D3DXVECTOR3 pos, GENERAL_MODEL_TYPE modelType, D3DXVECTOR3 size)
{
	//モデルクラスのポインタ変数
	CModel *pModel = NULL;
	...
	if (pModel != NULL)
	{
		...
		// モデルの割り当て
		pModel->BindModel(m_aGeneralModel[modelType].pMesh, m_aGeneralModel[modelType].pBuffMat, 1);
	}
	//メモリ確保に失敗したとき
	else
	{
