...
// 階層構造の読み込みクラス
//=============================================================================
void CModelHierarchy::LoadModels(char * pPath, CModel::Model *model,int * pNumModel)
{
	// ファイルオープン
	FILE*pFile = NULL;
	pFile = fopen(pPath, "r");
...
//テキストファイルの読み込み
//=============================================================================
void CModelHierarchy::LoadHierarchy(CModel::Model * model, char * pPath)
{
	// ファイルオープン
	FILE*pFile = NULL;
	pFile = fopen(pPath, "r");
...
HRESULT CModelHierarchy::Init(int nNumParts, CModel::Model * model, char*pPath)
{
...
void CModelHierarchy::SetModelData(CModel::Model *pModel)
{
